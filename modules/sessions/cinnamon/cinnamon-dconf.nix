{
  flake.homeModules.cinnamon-dconf =
    { lib, ... }:
      ...
      dconf.settings = {
        "org/cinnamon" = {
          ...
          enabled-applets = [
            ...
            "panel1:right:12:calendar@cinnamon.org:13"
            "panel1:right:13:cornerbar@cinnamon.org:14"
            "panel1:right:1:weather@mockturtl:15"
            "panel1:center:0:workspace-switcher@cinnamon.org:16"
          ];
          enabled-desklets = [ ];
          next-applet-id = 17;
        ...
        "org/cinnamon/desktop/keybindings/wm" = {
          ...
          move-to-workspace-down = [
            ...
            "<Primary><Shift><Super>j"
          ];
          move-to-workspace-left = [
            "<Control><Shift><Alt>Left"
            "<Primary><Shift><Super>h"
          ];
          move-to-workspace-right = [
            "<Control><Shift><Alt>Right"
            "<Primary><Shift><Super>l"
          ];
          move-to-workspace-up = [
            "<Control><Shift><Alt>Up"
            "<Primary><Shift><Super>k"
          ];
          push-tile-down = [
            "<Super>Down"
            "<Shift><Super>j"
